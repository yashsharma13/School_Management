...
//     return Scaffold(
//       appBar: CustomAppBar(title: "My Assigned Homework"),
//       body: isLoading
...
// class _ViewHomeworkPageState extends State<ViewTeacherHomeworkPage> {
//   bool isLoading = true;
//   String error = '';
//   List<dynamic> homeworkList = [];
//   static final String baseUrl = dotenv.env['NEXT_PUBLIC_API_BASE_URL'] ?? '';
...
//   // Launch URL in browser or appropriate handler
//   Future<void> _openPdf(String pdfFilePath) async {
//     final fileName = Uri.encodeComponent(pdfFilePath.split('/').last);
