...
//   bool _loading = false, _initialLoading = true;
...
//     // final encodedName = Uri.encodeComponent(s.name);
//     Navigator.push(
//       context,
//       MaterialPageRoute(
...
//         .toList();
//     return Scaffold(
//       // appBar: AppBar(title: const Text("Send Messages")),
//       appBar: CustomAppBar(title: 'Send Messages'),
//       body: Padding(
...
//                     TextField(
//                       decoration:
//                           const InputDecoration(labelText: 'Search student'),
