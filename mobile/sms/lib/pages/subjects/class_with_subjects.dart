...
//                   _buildEditButton(classData, subject), // ✅ Now it's valid
//                 ],
//               );
//             }).toList(),
...
//   Widget _buildEditButton(ClassWithSubjects classData, Subject subjectData) {
//     return Padding(
...
//         icon: Icons.edit,
//         onPressed: () async {
//           _navigateToEditPage(classData, subjectData);
//         },
...
//   void _navigateToEditPage(ClassWithSubjects classData, Subject subjectData) {
//     Navigator.push(
//       context,
//       MaterialPageRoute(
...
//     return Subject(
//       id: json['id'].toString(), // Make sure it's a String
//       subjectNames: (json['subject_name'] as String).split(', '),
//       marks: (json['marks'] as String).split(', '),
//     );
//   }
