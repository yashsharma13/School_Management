...
//         text: _formatDate(student.dateOfBirth)); // Format date here
//     final genderController = TextEditingController(text: student.gender);
//     final addressController = TextEditingController(text: student.address);
//     final fatherNameController =
//         TextEditingController(text: student.fatherName);
...
//                 _buildTextField(dobController, 'Date of Birth (DD-MM-YYYY)'),
...
//                 _buildTextField(classController, 'Assigned Class'),
//                 _buildTextField(sectionController, 'Assigned Section'),
