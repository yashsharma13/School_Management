...
//         setState(() {
//           studentAttendanceRecords = data.map((item) {
...
//     return Scaffold(
//       appBar: AppBar(title: Text('Student Attendance Report')),
//       body: Padding(
...
//               },
//               items: classes.map<DropdownMenuItem<String>>((String classItem) {
...
//               child:
//                   Text('Select Date: ${DateFormat.yMd().format(selectedDate)}'),
//             ),
//             Expanded(
//               child: ListView(
//                 children: studentAttendanceRecords.map((attendance) {
//                   return ListTile(
...
class _StudentReportPageState extends State<StudentReportPage> {
  ...
  Future<void> fetchAttendance() async {
    ...
    try {
      print(
          'Fetching attendance data for ${selectedClass} on ${formattedDate}');
